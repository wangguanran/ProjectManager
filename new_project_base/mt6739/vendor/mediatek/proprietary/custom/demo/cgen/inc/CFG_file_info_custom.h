...
extern "C"
{
    ...
    const TCFG_FILE g_akCFG_File_Custom[]=
    {
        ...
        { "/data/nvram/media/Audio_Sph_Lpbk",   VER(AP_CFG_RDCL_FILE_AUDIO_SPEECH_LPBK_PARAM_LID), CFG_FILE_SPEECH_LPBK_PARAM_SIZE,
            CFG_FILE_SPEECH_LPBK_PARAM_TOTAL, SIGNLE_DEFUALT_REC  ,    (char *)&speech_lpbk_param_custom_default, DataReset , NULL
        },
        { "/data/nvram/media/Audio_BT_Gain",   VER(AP_CFG_RDCL_FILE_AUDIO_BT_GAIN_CUSTOM_LID), CFG_FILE_AUDIO_BT_GAIN_CUSTOM_SIZE,
            CFG_FILE_AUDIO_BT_GAIN_CUSTOM_TOTAL, SIGNLE_DEFUALT_REC  ,    (char *)&bt_gain_control_default, DataReset , NULL
        },
        { "/data/nvram/media/AUDIO_FUNC_SWITCH_Param",   VER(AP_CFG_RDCL_FILE_AUDIO_FUNC_SWITCH_PARAM_LID), CFG_FILE_AUDIO_FUNC_SWITCH_PARAM_SIZE,
            CFG_FILE_AUDIO_FUNC_SWITCH_PARAM_TOTAL, SIGNLE_DEFUALT_REC  ,    (char *)&audio_func_swtich_param_custom_default, DataReset , NULL
        },
        {
            "/data/nvram/APCFG/APRDCL/FG",         VER(AP_CFG_CUSTOM_FILE_FUEL_GAUGE_LID),	           CFG_FILE_FG_CONFIG_SIZE,
