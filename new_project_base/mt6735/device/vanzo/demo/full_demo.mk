...
$(call inherit-product, device/vanzo/demo/device.mk)
...
KERNEL_DEFCONFIG ?= demo_debug_defconfig
else
KERNEL_DEFCONFIG ?= demo_defconfig
endif
PRELOADER_TARGET_PRODUCT ?= demo
LK_PROJECT ?= demo
TRUSTY_PROJECT ?= demo
